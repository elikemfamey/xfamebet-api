...
// A display-only fallback when a live provider is unavailable. It uses a
// neutral Poisson remaining-goals estimate; markets remain suspended and it
// never creates a price that can be placed in a bet slip.
